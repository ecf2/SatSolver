    ...
    while (!isSat && !initialCondition) {
      ...
      for (let i= 0; i<clauses.length; i++){
          ...
          for (let j=0; j<clauses[i].length; j++){
              ...
              //If there is at least one variable in the clause that is true, the whole clause is already true
              if (clausesvalue==true){
                  j = clauses[i].length;
              }
